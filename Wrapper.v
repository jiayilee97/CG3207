...
wire dec_DATA_CONST
    ...
    , dec_PB
    , dec_7SEG
    , dec_CONSOLE_IN_valid
    , dec_CONSOLE_OUT_ready;  // 'enable' signals from data memory address decoding
...
// Lab 4 (all remaining DP instructions)
//INSTR_MEM[0] = 32'hE59F11F8; 
//			INSTR_MEM[1] = 32'hE59F21F8; 
//			INSTR_MEM[2] = 32'hE59F3214; 
//			INSTR_MEM[3] = 32'hE5924000; 
//			INSTR_MEM[4] = 32'hE5814000; 
//			INSTR_MEM[5] = 32'hE2846005; 
//			INSTR_MEM[6] = 32'hE0070396; 
//			INSTR_MEM[7] = 32'hE0866007; 
//			INSTR_MEM[8] = 32'hE2237000; 
//			INSTR_MEM[9] = 32'hE267700F; 
//			INSTR_MEM[10] = 32'hE2577001; 
//			INSTR_MEM[11] = 32'hE0A77007; 
//			INSTR_MEM[12] = 32'hE2C77001; 
//			INSTR_MEM[13] = 32'hE2E3700F; 
//			INSTR_MEM[14] = 32'hE2977001; 
//			INSTR_MEM[15] = 32'hE3170000; 
//			INSTR_MEM[16] = 32'hE33700FF; 
//			INSTR_MEM[17] = 32'hE2977001; 
//			INSTR_MEM[18] = 32'hE3A0700F; 
//			INSTR_MEM[19] = 32'hE2077000; 
//			INSTR_MEM[20] = 32'hE3A07001; 
//			INSTR_MEM[21] = 32'hEAFFFFFE; 
...
// Lab 4 Console
			...
			INSTR_MEM[7] = 32'hE2862001; 
			INSTR_MEM[8] = 32'hE2822030; 
			INSTR_MEM[9] = 32'hE58B2000; 
			INSTR_MEM[10] = 32'hE2862003; 
			INSTR_MEM[11] = 32'hE2822030; 
			INSTR_MEM[12] = 32'hE58B2000; 
			INSTR_MEM[13] = 32'hE5993000; 
			INSTR_MEM[14] = 32'hE3530000; 
			INSTR_MEM[15] = 32'h0AFFFFF9; 
			INSTR_MEM[16] = 32'hE59A3000; 
			INSTR_MEM[17] = 32'hE3530030; 
			INSTR_MEM[18] = 32'hBAFFFFF6; 
			INSTR_MEM[19] = 32'hE3530039; 
			INSTR_MEM[20] = 32'hCAFFFFF4; 
			INSTR_MEM[21] = 32'hE2433030; 
			INSTR_MEM[22] = 32'hE2862004; 
			INSTR_MEM[23] = 32'hE2822030; 
			INSTR_MEM[24] = 32'hE58B2000; 
			INSTR_MEM[25] = 32'hE5994000; 
			INSTR_MEM[26] = 32'hE3540000; 
			INSTR_MEM[27] = 32'h0AFFFFF9; 
			INSTR_MEM[28] = 32'hE59A4000; 
			INSTR_MEM[29] = 32'hE3540020; 
			INSTR_MEM[30] = 32'h1AFFFFF6; 
			INSTR_MEM[31] = 32'hE2862005; 
			INSTR_MEM[32] = 32'hE2822030; 
			INSTR_MEM[33] = 32'hE58B2000; 
			INSTR_MEM[34] = 32'hE5994000; 
			INSTR_MEM[35] = 32'hE3540000; 
			INSTR_MEM[36] = 32'h0AFFFFF9; 
			INSTR_MEM[37] = 32'hE59A4000; 
			INSTR_MEM[38] = 32'hE3540030; 
			INSTR_MEM[39] = 32'hBAFFFFF6; 
			INSTR_MEM[40] = 32'hE3540039; 
			INSTR_MEM[41] = 32'hCAFFFFF4; 
			INSTR_MEM[42] = 32'hE2444030; 
			INSTR_MEM[43] = 32'hE2862006; 
			INSTR_MEM[44] = 32'hE2822030; 
			INSTR_MEM[45] = 32'hE58B2000; 
			INSTR_MEM[46] = 32'hE5992000; 
			INSTR_MEM[47] = 32'hE3520000; 
			INSTR_MEM[48] = 32'h0AFFFFF9; 
			INSTR_MEM[49] = 32'hE59A2000; 
			INSTR_MEM[50] = 32'hE3520041; 
			INSTR_MEM[51] = 32'h0A00001E; 
			INSTR_MEM[52] = 32'hE3520042; 
			INSTR_MEM[53] = 32'h0A00001E; 
			INSTR_MEM[54] = 32'hE3520043; 
			INSTR_MEM[55] = 32'h0A00001E; 
			INSTR_MEM[56] = 32'hE3520044; 
			INSTR_MEM[57] = 32'h0A00001E; 
			INSTR_MEM[58] = 32'hE3520045; 
			INSTR_MEM[59] = 32'h0A00001E; 
			INSTR_MEM[60] = 32'hE3520046; 
			INSTR_MEM[61] = 32'h0A00001E; 
			INSTR_MEM[62] = 32'hE3520047; 
			INSTR_MEM[63] = 32'h0A00001E; 
			INSTR_MEM[64] = 32'hE3520048; 
			INSTR_MEM[65] = 32'h0A00001E; 
			INSTR_MEM[66] = 32'hE3520049; 
			INSTR_MEM[67] = 32'h0A00001E; 
			INSTR_MEM[68] = 32'hE352004A; 
			INSTR_MEM[69] = 32'h0A00001E; 
			INSTR_MEM[70] = 32'hE352004B; 
			INSTR_MEM[71] = 32'h0A00001E; 
			INSTR_MEM[72] = 32'hE352004C; 
			INSTR_MEM[73] = 32'h0A00001E; 
			INSTR_MEM[74] = 32'hE352004D; 
			INSTR_MEM[75] = 32'h0A00001E; 
			INSTR_MEM[76] = 32'hE352004E; 
			INSTR_MEM[77] = 32'h0A00001E; 
			INSTR_MEM[78] = 32'hE352004F; 
			INSTR_MEM[79] = 32'h0A00001E; 
			INSTR_MEM[80] = 32'hE3520050; 
			INSTR_MEM[81] = 32'h0A00001E; 
			INSTR_MEM[82] = 32'hEAFFFFD7; 
			INSTR_MEM[83] = 32'hE0035004; 
			INSTR_MEM[84] = 32'hEA00001D; 
			INSTR_MEM[85] = 32'hE0235004; 
			INSTR_MEM[86] = 32'hEA00001B; 
			INSTR_MEM[87] = 32'hE0435004; 
			INSTR_MEM[88] = 32'hEA000019; 
			INSTR_MEM[89] = 32'hE0635004; 
			INSTR_MEM[90] = 32'hEA000017; 
			INSTR_MEM[91] = 32'hE0835004; 
			INSTR_MEM[92] = 32'hEA000015; 
			INSTR_MEM[93] = 32'hE0A35004; 
			INSTR_MEM[94] = 32'hEA000013; 
			INSTR_MEM[95] = 32'hE0C35004; 
			INSTR_MEM[96] = 32'hEA000011; 
			INSTR_MEM[97] = 32'hE0E35004; 
			INSTR_MEM[98] = 32'hEA00000F; 
			INSTR_MEM[99] = 32'hE1130004; 
			INSTR_MEM[100] = 32'hEAFFFFA4; 
			INSTR_MEM[101] = 32'hE1330004; 
			INSTR_MEM[102] = 32'hEAFFFFA2; 
			INSTR_MEM[103] = 32'hE1530004; 
			INSTR_MEM[104] = 32'hEAFFFFA0; 
			INSTR_MEM[105] = 32'hE1730004; 
			INSTR_MEM[106] = 32'hEAFFFF9E; 
			INSTR_MEM[107] = 32'hE1835004; 
			INSTR_MEM[108] = 32'hEA000005; 
			INSTR_MEM[109] = 32'hE1A05003; 
			INSTR_MEM[110] = 32'hEA000003; 
			INSTR_MEM[111] = 32'hE1C35004; 
			INSTR_MEM[112] = 32'hEA000001; 
			INSTR_MEM[113] = 32'hE1E05003; 
			INSTR_MEM[114] = 32'hEAFFFFFF; 
			INSTR_MEM[115] = 32'hE2862007; 
			INSTR_MEM[116] = 32'hE2822030; 
			INSTR_MEM[117] = 32'hE58B2000; 
			INSTR_MEM[118] = 32'hE2855030; 
			INSTR_MEM[119] = 32'hE5982000; 
			INSTR_MEM[120] = 32'hE3540000; 
			INSTR_MEM[121] = 32'h0AFFFFF8; 
			INSTR_MEM[122] = 32'hE58A5000; 
			INSTR_MEM[123] = 32'hEAFFFF8D; 
			for(i = 124; i < 128; i = i+1) begin 
				INSTR_MEM[i] = 32'h0; 
			end
end
//----------------------------------------------------------------
...
//			DATA_CONST_MEM[20] = 32'h00000C09; 
